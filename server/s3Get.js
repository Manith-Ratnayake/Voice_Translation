...
//await s3transcriptionToText({ file: "TranscriptionJob_1_audio-0.wav.json" });
...
await s3transcriptionToText(`TranscriptionJob_1_audio-0.wav.json`)
//bk = "voiceoutputbucketmanithratnayake"
